...
class ICARAFE(nn.Module):
    def __init__(self, c1, c2, kernel_size=5, up_factor=2):
        super(ICARAFE, self).__init__()
        self.kernel_size = 5
        self.up_factor = 2
